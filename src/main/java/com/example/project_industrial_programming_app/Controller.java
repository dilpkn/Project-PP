...
public class Controller {
    ...
    public void setFilenameInput(String filename) {
        filename_input.setText(filename); // Используем существующий объект TextField
    }

    public void setFilenameOutput(String filename) {
        filename_output.setText(filename); // Используем существующий объект TextField
    }


    public void setFormatIn(String format) {
        this.format_in = new ChoiceBox<>();
        this.format_in.setValue(format);
    }

    public void setFormatOut(String format) {
        this.format_out = new ChoiceBox<>();
